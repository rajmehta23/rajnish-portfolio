...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState([
    { role: 'bot', text: "Hi! I'm Rajnish's AI assistant. Ask me anything about his skills, projects, or background!" }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await getGeminiResponse(userMsg, chatHistory);
